...
using namespace std;
using namespace cv;
// ex2-6 RotatedRect template class
int main(){
    ...
    cout << "rt1 : ptCenter(" << rt1.center.x << "," << rt1.center.y << ")" << "size =(" << rt1.size.width << "," << rt1.size.height << ")" << "(angle =" << rt1.angle << ")" << endl;
    cout << rt2.x << " , " << rt2.y << " , " << rt2.width << " , " << rt2.height << endl;
