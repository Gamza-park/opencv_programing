...
int main()
{
    ...
    line(dstImage,Point(center.x,center.y-size.height),Point(center.x,center.y+size.height),Scalar(255,0,0));

    ellipse(dstImage,center,size,0,0,360,Scalar(0,0,250));
    ellipse(dstImage,center,size,90,45,360,Scalar(0,0,250),2);
